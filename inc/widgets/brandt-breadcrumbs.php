 ...
 * @since 1.0.0
 */
class Brandt_Breadcrumbs_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Brandt Breadcrumbs', 'plugin-name' );
	}
    ...
    $output =  _breadcrumbs_template($settings);
