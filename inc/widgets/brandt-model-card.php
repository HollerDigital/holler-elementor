 ...
 * @since 1.0.0
 */
class Brandt_Model_Card_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Brandt Model Card', 'plugin-name' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'Light',
				'options' => [
					'card-model--light'  => __( 'Light', 'plugin-domain' ),
					'card-model--dark' => __( 'Dark', 'plugin-domain' ),
					'card-model--accent' => __( 'Accent', 'plugin-domain' )
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Type your name here', 'plugin-domain' ),
			]
		);
		...
		$this->add_control(
			'widget_title',
			[
				'label' => __( 'Secondary Title', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'product_url',
			[
				'label' => __( 'Product Link', 'plugin-domain' ),
	...
	$output =  _model_template($settings);
