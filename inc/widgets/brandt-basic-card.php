 ...
 * @since 1.0.0
 */
class Brandt_Basic_Card_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Brandt Basic Card', 'plugin-name' );
	}
    ...
    $output =  _basic_card_template($settings);
